...

        {
          loading ? (
            ...
            data.map((product, index) => {
              return (
                <Link key={index} to={"/product/" + product?._id} className='w-full min-w-[280px] md:min-w-[300px] max-w-[280px] md:max-w-[310px] bg-white rounded-sm shadow' onClick={scrollTop}>
